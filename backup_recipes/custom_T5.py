...
class ChefT5(pl.LightningModule):
    ...
    def __init__(self, data, lr=5e-5, num_train_epochs=15, warmup_steps=1000):
        #super(ChefT5, self).__init__()
        super().__init__()
        self.model = T5ForConditionalGeneration.from_pretrained("t5-small")
        self.train_dataloader = data["train"]
        self.test_dataloader = data["test"]
        self.dev_dataloader = data["dev"]
    ...
    def validation_step(self, batch, batch_idx):
        loss = self.common_ste(batch, batch_idx)
